...
type NFDeployStatus struct {
	...
	// Total number of NFs targeted by this deployment with a Ready Condition.
	ReadyNFs int32 `json:"readyNFs,omitempty"`

	// Total number of available NFs targeted by this deployment.
	AvailableNFs int32 `json:"availableNFs,omitempty"`

	// Total number of stalled NFs targeted by this deployment.
